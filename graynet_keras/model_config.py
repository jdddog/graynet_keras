...
from graynet_keras.utils import get_file
...
def get_weight_path(init_model_name, pretrained_model_name, n_ch):
    ...
    if (init_model_name, pretrained_model_name, n_ch) == ("vgg16", "imagenet", 3):
        weights_filename = os.path.join(base_dir, pretrained_model_name, init_model_name,
                                        "{}-{}ch.h5".format(init_model_name, n_ch))
    ...
    elif (init_model_name, pretrained_model_name, n_ch) == (
            "unetenc", "imagenet", 3):  ## Not trainned from ImageNet data
        raise NotImplementedError
    elif (init_model_name, pretrained_model_name, n_ch) == (
            "unetenc", "imagenet", 1):  ## Not trainned from ImageNet data
        raise NotImplementedError
    ...
    # GrayNet pretrained model for Grayscale
        ...
        print(
            "[ERROR]", "INIT MODEL NAME:", init_model_name, "pretrained_model_name:", pretrained_model_name, "nch:",
            n_ch)
        raise NotImplementedError
